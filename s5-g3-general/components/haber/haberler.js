...
const HaberYapici = (baslik, tarih, ilkP, ikinciP, ucuncuP) => {
  ...
  p2.textContent = ikinciP;
  div.appendChild(p2);

  const p3 = document.createElement('p');
  p3.textContent = ucuncuP;
  div.appendChild(p3);
...
data.forEach((item) => {
  ...
  container.appendChild(sonuc);
});

data.push([
  {
    baslik: 'Google’ın Yapay Zeka Rotasını Bir Türk Çizecek!',
    tarih: '12 Haziran 2025 ',
    ilkParagraf:
      'Google, yapay zeka alanındaki yatırımlarını ürünlerine daha hızlı entegre edebilmek için önemli bir adım attı.',
    ikinciParagraf:
      'Şirket, DeepMind’ın Teknoloji Direktörü (CTO) Koray Kavukcuoğlu’nu yeni oluşturulan Baş Yapay Zekâ Mimarı (Chief AI Architect) pozisyonuna atadığını duyurdu.',
    ucuncuParagraf:
      'Kavukcuoğlu’nun liderliğiyle bu projelerin daha kararlı ve hızlı bir şekilde hayata geçmesi bekleniyor.',
  },
  {
    baslik: 'ChatGPT Neden Çalışmıyor? ChatGPT Mesaj Akışında Hata Çözümü',
    tarih: '10 Haziran 2025',
    ilkParagraf:
      'OpenAI tarafından geliştirilen ChatGPT, dünya genelinde milyonlarca kullanıcıyı etkileyen büyük bir kesintiyle karşı karşıya kaldı. ABD, İngiltere, Hindistan, Avrupa, Japonya ve Avustralya gibi birçok bölgede kullanıcılar, ChatGPT’ye erişimde sorunlar yaşadı. ChatGPT neden çalışmıyor? ChatGPT mesaj akışında hata, ChatGPT too many concurrent requests? Error in message stream chatgpt? İşte bu kesintiye dair tüm detaylar ve özgün bir anlatımla güncel gelişmeler:',
    ikinciParagraf:
      'Ne Zaman Başladı? Kesinti, 10 Haziran Salı sabahı erken saatlerde, Türkiye saatiyle yaklaşık 09:00 civarında başladı. Kullanıcılar, ChatGPT’ye web sitesi ve mobil uygulama üzerinden erişmeye çalışırken sorunlarla karşılaştı.',
    ucuncuParagraf:
      'Etkilenen Bölgeler: Kesinti, global çapta etkili oldu ve ABD, İngiltere, Hindistan, Japonya, Avustralya gibi ülkelerde yoğun şikayetler bildirildi.',
  },
]);
